...
public static void initialize(){
	...
	//metro_center.otherStations.add(farragut_north); // Red Line connection
   // metro_center.otherStations.add(gallery_place);
	//metro_center.otherStations.add(mcpherson_square);  // Orange Line connection
    //metro_center.otherStations.add(s3);  
}
